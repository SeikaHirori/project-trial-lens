...
class TrialLens {
    constructor(patient) {
        ...
        __classPrivateFieldSet(this, _TrialLens_refractiveErrorType, new RefractiveErrorType_1.Myopia(__classPrivateFieldGet(this, _TrialLens_currentPatient, "f")), "f"); // FIXME ; This is placeholder... Use function "determineRefractiveErrorType() when it is written out."
    }
}
